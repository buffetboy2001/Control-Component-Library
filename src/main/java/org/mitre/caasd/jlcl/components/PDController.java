...
/**
 * A pre-built Proportional-Derivative control component that subclasses {@link PID}. The integrator term is guaranteed to remain zero.
 * 
 * @param <NUMERICTYPE>
...
public class PDController<NUMERICTYPE extends Number, DIFFERENTIATOR extends IDifferentiate<NUMERICTYPE, DIFFERENTIATOR_ARGS_TYPE>, DIFFERENTIATOR_ARGS_TYPE extends IDifferentiateArguments<NUMERICTYPE>>
        ...
        NoIntegration<NUMERICTYPE>,
        NoIntegrationArguments<NUMERICTYPE>,
        DIFFERENTIATOR,
        DIFFERENTIATOR_ARGS_TYPE> {
    ...
    public PDController(Class<NUMERICTYPE> clazz, NUMERICTYPE proportionalGain, DIFFERENTIATOR differentiatorInstance, NUMERICTYPE differentiatorGain) {
        super(clazz, proportionalGain, new NoIntegration<NUMERICTYPE>(clazz), (NUMERICTYPE) ParameterizedExtendsNumber.getZeroForClazz(clazz), differentiatorInstance, differentiatorGain);
    }
}
